...
namespace Cosair {
	...
	void OpenGLShader::UploadUniformVec4(const char* name, const glm::vec4& value) {
		uint32_t location = glGetUniformLocation(m_ProgramID, name);
		glUniform4f(location, value.x, value.y, value.z, value.w);
	}

	void OpenGLShader::UploadUniformVec3(const char* name, const glm::vec3& value) {
		uint32_t location = glGetUniformLocation(m_ProgramID, name);
		glUniform3f(location, value.x, value.y, value.z);
	}

	void OpenGLShader::UploadUniformVec2(const char* name, const glm::vec2& value) {
		uint32_t location = glGetUniformLocation(m_ProgramID, name);
	...
	void OpenGLShader::UploadUniformInt4(const char* name, const glm::ivec4& value) {
		uint32_t location = glGetUniformLocation(m_ProgramID, name);
		glUniform4i(location, value.x, value.y, value.z, value.w);
	}

	void OpenGLShader::UploadUniformInt3(const char* name, const glm::ivec3& value) {
		uint32_t location = glGetUniformLocation(m_ProgramID, name);
		glUniform3i(location, value.x, value.y, value.z);
	}

	void OpenGLShader::UploadUniformInt2(const char* name, const glm::ivec2& value) {
		uint32_t location = glGetUniformLocation(m_ProgramID, name);
