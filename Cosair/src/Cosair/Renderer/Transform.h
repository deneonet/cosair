...
namespace Cosair {
    ...
    public:
        ...
        inline void SetScale(const glm::vec3& scale) { m_Scale = scale; RecalculateTransformMatrix(); }
        inline void SetPosition(const glm::vec3& position) { m_Position = position; RecalculateTransformMatrix(); }
    ...
    private:
        ...
        glm::mat4 m_TransformMatrix; // Cache calculation of the position, rotation and scale, only updated on changes
    };
